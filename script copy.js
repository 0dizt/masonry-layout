...
class Grid {
  ...
  outViewport(el) {
    // console.log(el);
    var scrollSensitivity = Math.abs(10) || 0,
      scrolled = scrollY(),
      viewed = scrolled + getViewportH(),
      elT = getOffset(el).top,
      elHalfpos = elT + el.offsetHeight / 2,
      belowViewport = elT + el.offsetHeight + scrollSensitivity > viewed,
